...
from pymine_net.net.asyncio import AsyncProtocolServer, AsyncTCPClient, AsyncProtocolServerClient
...
async def test_asyncio_net_status():
    ...
    await client.write_packet(HandshakeHandshake(TESTING_PROTOCOL, TESTING_HOST, TESTING_PORT, GameState.STATUS))
